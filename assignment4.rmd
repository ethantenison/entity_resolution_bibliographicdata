---
title: 'Assignment 4: Disambiguation using algorithm'
author: "Alex Meed, Andrew Messamore, Ethan Tenison, Mychal Warner"
date: "11/17/2019"
output:
  md_document: default
---
...
In this exercise we created two separate dataframes using our disambiguation method. 
...
Capturing all of the authors first and last names and appending them together. 
...
There is relatively low distance between the actual data and the fuzzy match that we used, with just a 10% threshold of different. 
...
1) who are the most productive authors in nonprofit studies? 
The top 3 authors are Edgard Milhaud, Dennis Young, and Anghel Rugina. All three had a strong background in economics. 

2) Which are the most productive institutions in nonprofit studies? 
The top 3 organizations were USC, Indiana University, and the University of Queensland. 

3) How you define “productive.”
Our algorithm equates productive to be the total number of publications. 